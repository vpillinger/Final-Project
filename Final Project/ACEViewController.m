...
- (IBAction)takeScreenshot:(id)sender
{
    ...
    */
    //send the image to the tabbarcontroller
    _myTabBar.currentDrawingImage = self.drawingView.image;
}
...
- (IBAction)colorChange:(id)sender
{
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:@"Selet a color"
                                               ...
                                               destructiveButtonTitle:nil
                                                    otherButtonTitles:@"White", @"Red", @"Green", @"Blue", nil];
